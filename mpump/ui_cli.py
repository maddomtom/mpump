"""mpump-ui entry point — terminal UI launcher."""

import argparse
import sys

from .keys import DEFAULT_KEY, DEFAULT_OCTAVE, OCTAVE_MIN, OCTAVE_MAX, valid_key_names
from .patterns import GENRE_NAMES
from .patterns_t8 import T8_GENRE_NAMES
from .patterns_j6 import J6_GENRE_NAMES
...
def parse_args() -> argparse.Namespace:
    ...
    s1.add_argument("--genre",   default=DEFAULT_GENRE,   choices=GENRE_NAMES,   metavar="GENRE",
                    help=f"Pattern genre (default: {DEFAULT_GENRE})")
    s1.add_argument("--pattern", type=int, default=DEFAULT_PATTERN, metavar="N",
                    help=f"Pattern 1–10 within genre (default: {DEFAULT_PATTERN})")
    s1.add_argument("--key",     default=DEFAULT_KEY,     metavar="KEY",
                    help=f"Root key, e.g. A, F#, Bb (default: {DEFAULT_KEY})")
    s1.add_argument("--octave",  type=int, default=DEFAULT_OCTAVE, metavar="N",
    ...
    j6.add_argument("--j6-genre",   default=DEFAULT_J6_GENRE,   choices=J6_GENRE_NAMES, metavar="GENRE",
                    help=f"J-6 chord genre (default: {DEFAULT_J6_GENRE})")
    j6.add_argument("--j6-pattern", type=int, default=DEFAULT_J6_PATTERN, metavar="N",
